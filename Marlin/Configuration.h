...
#define STRING_VERSION "v1.0.3"
#define STRING_URL "flucher.eu"
#define STRING_VERSION_CONFIG_H __DATE__ " " __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "(K8200, Mario Flucher)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,2133.33,600}  // default steps per unit for K8200
